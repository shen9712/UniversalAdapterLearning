...
@dataclass
class Wav2Vec2AsrADLANGINVConfig(FairseqDataclass):
    # szj
...
@dataclass
class Wav2Vec2CtcADLANGIVConfig(Wav2Vec2AsrADLANGINVConfig):
    pass


@register_model("wav2vec_ctc_ad_lang_inv", dataclass=Wav2Vec2CtcADLANGIVConfig)
class Wav2VecCtcAD(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2CtcADLANGIVConfig, w2v_encoder: BaseFairseqModel):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: Wav2Vec2CtcADLANGIVConfig, task: FairseqTask):
        """Build a new model instance."""
        w2v_encoder = Wav2VecEncoderADLANGINV(cfg, task.target_dictionary)
...
class Wav2VecEncoderADLANGINV(FairseqEncoder):
    def __init__(self, cfg: Wav2Vec2AsrADLANGINVConfig, tgt_dict=None):
        ...
        w2v_args.model['_name'] = 'wav2vec2_ad_lang_inv'
