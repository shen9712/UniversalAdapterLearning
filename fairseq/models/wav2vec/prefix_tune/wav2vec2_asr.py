...
@register_model("wav2vec_ctc_prefix_tune", dataclass=Wav2Vec2CtcADConfig)
...
class Wav2VecEncoderAD(FairseqEncoder):
    def __init__(self, cfg: Wav2Vec2AsrADConfig, tgt_dict=None):
        ...
        w2v_args.model['_name'] = 'wav2vec2_prefix_tune'
        ...
        # szj 冻结除了prefix-tuning的参数
        # TODO 
        for name, param in self.w2v_model.named_parameters():
            if param.requires_grad and 'prefix_tune' not in name:
