...
# szj
from fairseq.models.wav2vec.prefix_tune_langlogits.attention import multi_head_attention_forward
...
class PrefixTuningLangEmb(nn.Module):
    ...
    def forward(self, batch_size, language_id):
        """
        此处的language_id为language logits
        """
        device = next(self.parameters()).device
        ...
        embs = language_id  # b x 1 x input_szie
