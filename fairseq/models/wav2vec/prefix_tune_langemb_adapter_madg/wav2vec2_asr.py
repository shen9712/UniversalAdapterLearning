...
@register_model("wav2vec_ctc_prefix_tune_lang_emb_adapter_madg", dataclass=Wav2Vec2CtcADConfig)
...
class Wav2VecEncoderAD(FairseqEncoder):
    def __init__(self, cfg: Wav2Vec2AsrADConfig, tgt_dict=None):
        ...
        w2v_args.model['_name'] = 'wav2vec2_prefix_tune_lang_emb_adapter_madg'
