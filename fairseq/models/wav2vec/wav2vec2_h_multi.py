...
#             if not self.training or (dropout_probability > self.layerdrop) or i in self.special_layers: ## szj
#                 x, z = layer(x, self_attn_padding_mask=padding_mask, need_weights=False)
#                 # layer_results.append(x)
#                 if i in self.special_layers:
#                     x_inter[str(i)] = x.transpose(0, 1) ## szj keys的顺序是加入词典的顺序，因此底层在前，高层在后
