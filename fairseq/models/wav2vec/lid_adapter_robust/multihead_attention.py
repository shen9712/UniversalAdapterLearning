...
# szj
from fairseq.models.wav2vec.prefix_tune_langemb_adapter_robust.attention import multi_head_attention_forward
...
class PrefixTuningLangEmb(nn.Module):
    def __init__(
        ...
        self.vocab_size = 7  # 4个语种 + 特殊符号（处理空样本）
        ...
        self.control_trans = nn.Sequential(
            nn.Linear(self.input_size, self.bottleneck_size, bias=False),
            nn.Tanh(),
            nn.Linear(self.bottleneck_size, self.n_layers * 2 * self.input_size, bias=False),
        )
