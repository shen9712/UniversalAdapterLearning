...
@register_criterion("ctc_adapter_fusion_l2", dataclass=CtcCriterionConfig)
class CtcCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        # szj added
        loss_l2 = model.get_fusion_regularization_loss()
        loss_guide = model.get_fusion_guide_loss('201', net_output)
        loss = loss + loss_l2 + loss_guide
